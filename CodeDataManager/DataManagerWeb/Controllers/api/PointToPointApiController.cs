...
{
    [Route("api/PointToPoint")]
    public class PointToPointApiController : ApiControllerBase
    {
        PointToPointCheckUtils CheckUtils { get; set; }
        public PointToPointApiController()
        {
            CheckUtils = new PointToPointCheckUtils();
        }
