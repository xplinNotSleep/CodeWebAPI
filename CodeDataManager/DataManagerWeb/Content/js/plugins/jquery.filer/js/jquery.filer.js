				...
				f = {
					...
					_thumbCreator: {
						...
						_box: function(params) {
							...
							if (n.uploadFile.isbatch) {
								f._thumbCreator.createbatch();
							}
							else {
								for (var i = 0; i < f.files.length; i++) {
					...
					_uploadbatch: function () {
						...
						f._itFl.forEach(function (obj, i) {
							if (!obj.uploaded) {
								formData.append(s.attr('name'), obj.file, (obj.file.name ? obj.file.name : false));
                            }
						});
						if (n.uploadFile.data != null && $.isPlainObject(n.uploadFile.data)) {
							for (var k in n.uploadFile.data) {
						...
						f._ajax.send(f._itFcHs, formData, f._itFl);
					},
					_ajax: {
							...
							$.ajax({
								...
								xhr: function() {
									...
									if(myXhr.upload) {
										myXhr.upload.addEventListener("progress", function (e) {
											if (Array.isArray(el)) {
												el.forEach(function (o, i) {
													f._ajax.progressHandling(e, o)
												});
											}
                                            else {
								...
								complete: function(jqXHR, textStatus) {
									...
									if(f._ajFc >= f.files.length) {
										f._ajFc = 0;
										n.uploadFile.onComplete != null && typeof n.uploadFile.onComplete == "function" ? n.uploadFile.onComplete( jqXHR, textStatus,l, p, o, s) : null;
									}
								},
								beforeSend: function (jqXHR, settings) {
									return n.uploadFile.beforeSend != null && typeof n.uploadFile.beforeSend == "function" ? n.uploadFile.beforeSend(jqXHR, settings, el, l, p, o, s, c.id,) : true;
								},
								success: function (data, textStatus, jqXHR) {
									...
									n.uploadFile.success != null && typeof n.uploadFile.success == "function" ? n.uploadFile.success(data, textStatus, jqXHR, el, l, p, o, s, c.id) : null
								},
								error: function(jqXHR, textStatus, errorThrown) {
									...
									n.uploadFile.error != null && typeof n.uploadFile.error == "function" ? n.uploadFile.error(jqXHR, textStatus, errorThrown,el, l, p, o, s, c.id) : null
								},
						...
						progressHandling: function(e, el) {
							if(e.lengthComputable) {
								var t = Math.round(e.loaded * 100 / e.total)
									.toString();
								n.uploadFile.onProgress != null && typeof n.uploadFile.onProgress == "function" ? n.uploadFile.onProgress(e,el,t,l, p, o, s) : null;
