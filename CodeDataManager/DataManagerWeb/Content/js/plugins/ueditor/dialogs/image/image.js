        ...
        initUploader: function () {
            ...
            uploader = _this.uploader = WebUploader.create({
                ...
                formData:{
                    ...
                    filetree: editor.getOpt("imagetree"),
                    referkey: editor.getOpt("referkey")
                },
                duplicate: true,
                fileSingleSizeLimit: 51200000,    // 默认 2 M
                compress:  {
                    width: 1600,
                    height: 1600,
            ...
            uploader.on('uploadSuccess', function (file, ret) {
                ...
                try {
                    ...
                    if (json.Status == 1) {
                        _this.imageList.push(json.Item);
        ...
        pushData: function (list) {
            ...
            for (i = 0; i < list.length; i++) {
                if(list[i] && list[i].Id) {
                    ...
                    img.width = 113;
                    img.setAttribute('src', urlPrefix + list[i].Id +  '?noCache=' + (+new Date()).toString(36) );
                    img.setAttribute('_src', urlPrefix + list[i].Id);
                    img.setAttribute('alt', list[i].FileName);
                    img.setAttribute('title', list[i].FileName);
