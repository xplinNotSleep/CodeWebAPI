...
namespace AGSpatialDataCheck.Domain
{
    ...
    /// 文件管理表
    /// </summary>
    public class FileStorageService : PDRepositoryBaseCustom<SqliteDbContext, FileStorageEntity>, IApplicationService
    {
        public FileStorageService(SqliteDbContext ctx) : base(ctx)
        { }
